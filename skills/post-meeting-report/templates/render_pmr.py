#!/usr/bin/env python3
"""
PMR HTML/PDF Renderer — fills the Jinja2 template with structured data.

Usage:
    python render_pmr.py input.json output.html
    python render_pmr.py input.json output.pdf

Input: JSON file with the PMR data structure (see sample_data.json).
...
def render_html(data: dict, template_dir: str = None) -> str:
    """Render PMR data into HTML string."""
